...
(function() {
	...
	Gridly = (function() {
		...
		Gridly.prototype.draggingBegan = function(event) {
			...
			return (ref = this.settings) != null ? (ref1 = ref.callbacks) != null ? typeof ref1.reordering === "function" ?
				ref1.reordering($elements) : void 0 : void 0 : void 0;
		};
		...
		Gridly.prototype.draggingEnded = function(event) {
			...
			this.ordinalize($elements);
			setTimeout(this.layout, 0);
			return (ref = this.settings) != null ? (ref1 = ref.callbacks) != null ? typeof ref1.reordered === "function" ?
				ref1.reordered($elements, this._draggable.dragged) : void 0 : void 0 : void 0;
		};
		...
		Gridly.prototype.size = function($element) {
			return (($element.data('width') || $element.outerWidth()) + this.settings.gutter) / (this.settings.base + this.settings
				.gutter);
		};
		...
		Gridly.prototype.position = function($element, columns) {
			...
			for (i = k = ref1 = column, ref2 = column + size; ref1 <= ref2 ? k < ref2 : k > ref2; i = ref1 <= ref2 ? ++k :
				--k) {
